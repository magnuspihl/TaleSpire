...
tile_catalog.json and build_tile_catalog.py live in /home/coder/TaleSpire-Binaries/ (not in this repo). Do not read tile_catalog.json into context — it is large reference data. Query it with grep or python when specific tile lookups are needed.
